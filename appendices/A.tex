...
\begin{table}[t]
    ...
    \begin{tabularx}{0.9\textwidth}{lc YY}
        ...
        \midrule
        \multirow{2}{*}{\emph{temperature}} & \footnotesize\textsc{SRE Agent} & $0.80$ & $0.80 \hspace{1em} (1.00 \text{ thinking})$ \\
        & \footnotesize\textsc{Code Agent}  & $0.60$ & $0.60 \hspace{1em} (1.00 \text{ thinking})$ \\
        \multirow{2}{*}{\emph{top\_p}} & \footnotesize\textsc{SRE Agent} & $0.95$ & $0.95 \hspace{1em} (1.00 \text{ thinking})$ \\
        & \footnotesize\textsc{Code Agent}  & $0.90$ & $0.90 \hspace{1em} (1.00 \text{ thinking})$ \\
        \emph{} & \\
