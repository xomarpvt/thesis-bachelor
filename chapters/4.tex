...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{img/componenti.png}
...
\begin{figure}[t]
    ...
    \caption[Diagramma della attività di analisi]{
        Diagramma delle attività e del flusso della pipeline di analisi.
    }
...
\begin{figure}[t]
    ...
    \caption[Diagramma di sequenza del tool calling]{
        Diagramma di sequenza delle operazioni coinvolte nel processo di tool calling.
    }
