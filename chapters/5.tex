...
Lo schema realizzato, conforme al JSON Schema Draft 2020-12 \footnote{\url{https://json-schema.org/draft/2020-12/json-schema-core.html}} è riportato tra le appendici. % \Cref{fig}
...
% https://ipinfo.io/developers/ipinfo-lite-database#attribution-and-licensing
% IPinfo Lite (Free) (Formato mmdb) 

% Free for commercial use with attribution. IPinfo Lite provides accurate country- and continent-level geolocation plus basic ASN details, delivered per-network (CIDR). Columns: network, country, country_code, continent, continent_code, asn, as_name, as_domain. Updated daily and licensed CC-BY-SA 4.0.

% GeoLite City, Country, ASN
