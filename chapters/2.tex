...
\begin{figure}[t]
    ...
    \caption[Topologie delle botnet]{Modelli e topologie delle botnet. Adattato da \cite{hachem2011topology}}
...
\begin{description}
    ...
    \begin{figure}[t]
        \centering
        \includegraphics[width=0.45\textwidth]{img/llm_decompile_end.pdf}%
        \hspace{0.05\textwidth}%
        \includegraphics[width=0.45\textwidth]{img/llm_decompile_ref.pdf}%
